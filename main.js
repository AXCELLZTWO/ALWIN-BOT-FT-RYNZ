...
global.owner = ['@s.whatsapp.net'] // Put your number here
global.mods = ['@s.whatsapp.net'] // Want some help?
global.prems = ['@s.whatsapp.net'] // Premium user has unlimited limit
...
global.prefix = new RegExp('^[' + (opts['prefix'] || '‎xzrXZR\\/i!#$%\\-+£¢€¥^°=¶∆×÷π√✓©®:;?&.') + ']')
...
conn.welcome = 'Hai, @user!\nSelamat datang di grup @subject\njadi mau keluar sendiri atau di kick'
conn.bye = 'Goodbye Beban group @user!'
